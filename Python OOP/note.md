...
- 判别对象的位置
    ...
    - 对象外部
    - 子类中
- [python中下划线的使用](https://blog.csgn.net/handsomekang/article/details/40301)
- 私有
...
- 基本定义
    ...
    - 多态不是语法，是一种设计思想
    - 多态性：一种调用方式，不同的执行效果
    - 多态：同一事物的多种形态，动物分人类，狗类，猪类
    - [多态和多态性](https://www.cnblogs.com/luchuangao/p/6739557.html)
- Mixin设计模式
    - 主要采用多继承方式对类的功能进行扩展
    - 我们使用多继承语法来实现Mixin
    - 使用Mixin来实现多继承的时候要非常小心
        - 首先他必须表示某一单一功能，而不是某个物品
        - 职责必须单一，如果有多个功能，则写多个Mixin
        - Mixin不能依赖于子类的实现
        - 子类即使没有继承这个Mixin类，也可以正常工作，只是缺少了某个功能
    - 优点：
...
- getattr：get attribute 获得一个对象的某个属性所对应的值
- setattr：set attribute 给一个对象设置命名属性并指定值
- delattr：delete attribute 从给定对象中删除命名属性 
- dir：获取对象的成员列表

# 8. 类的成员描述符（属性）参见案例------oop-4.ipynb
...
- 无论哪种修饰符都是为了对成员属性进行相应的控制
    ...
    - property方式：适用于当前类中使用，可以控制一个类中的多个属性
